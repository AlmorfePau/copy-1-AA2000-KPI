      ...
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
        <div className="space-y-4">
          <div className="flex items-center gap-2">
            ...
            <span className="px-3 py-1 bg-[#0f172a] text-white text-[10px] font-black uppercase tracking-widest rounded-md">LEVEL: DEPARTMENT HEAD</span>
          </div>
          <div>
            <h1 className="text-[40px] font-black text-[#1e293b] tracking-tight leading-none">Departmental Audit Console</h1>
        ...
        <div className="lg:col-span-8 space-y-8">
          ...
          <div className="bg-white rounded-[2.5rem] p-10 shadow-sm border border-slate-100">
            <div className="flex items-center gap-4 mb-12">
              ...
              <div>
                <h3 className="text-sm font-black text-[#1e293b] uppercase tracking-widest leading-none mb-1">DEPARTMENTAL ANALYTICS</h3>
                <p className="text-[10px] font-bold text-slate-300 uppercase tracking-widest">CROSS-UNIT EFFICIENCY ANALYSIS</p>
              </div>
            </div>
